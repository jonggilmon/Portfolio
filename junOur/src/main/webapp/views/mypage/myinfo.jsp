...
<title>내 정보 수정</title>
 ...
 <script>
   ...
   {
	   document.getElementById("chgname").style.display=sts;
    ...
    <table width="1000" align="center" cellspacing="0">
      ...
      <tr>
        ...
        <td> 
            ...
            <input type="button" value="번호변경 취소" onclick="chgPhone('none',this,0)" class="phoneBtn" style="display:none">
